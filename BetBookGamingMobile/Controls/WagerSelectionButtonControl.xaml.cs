...
public partial class WagerSelectionButtonControl : ContentView
{
    ...
    public static readonly BindableProperty CustomCommandParameterProperty = BindableProperty.Create(nameof(CustomCommandParameter), typeof(string), typeof(WagerSelectionButtonControl), propertyChanged: (bindable, oldValue, newValue) =>
    {
        var control = (WagerSelectionButtonControl)bindable;
    ...
    public static readonly BindableProperty CustomBackgroundColorProperty = BindableProperty.Create(nameof(CustomBackgroundColor), typeof(Color), typeof(WagerSelectionButtonControl), propertyChanged: (bindable, oldValue, newValue) =>
    {
        var control = (WagerSelectionButtonControl)bindable;
    ...
    public static readonly BindableProperty CustomTextProperty = BindableProperty.Create(nameof(CustomText), typeof(string), typeof(WagerSelectionButtonControl), propertyChanged: (bindable, oldValue, newValue) =>
    {
        var control = (WagerSelectionButtonControl)bindable;

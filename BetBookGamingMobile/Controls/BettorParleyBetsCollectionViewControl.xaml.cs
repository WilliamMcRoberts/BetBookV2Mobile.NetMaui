...
public partial class BettorParleyBetsCollectionViewControl : ContentView
{
    ...
    public static readonly BindableProperty CustomItemSourceProperty = BindableProperty.Create(nameof(CustomItemSource), typeof(ObservableCollection<ParleyBetSlipModel>), typeof(BettorParleyBetsCollectionViewControl), propertyChanged: (bindable, oldValue, newValue) =>
    {
    ...
    {
        get => (ObservableCollection<ParleyBetSlipModel>)GetValue(CustomItemSourceProperty);

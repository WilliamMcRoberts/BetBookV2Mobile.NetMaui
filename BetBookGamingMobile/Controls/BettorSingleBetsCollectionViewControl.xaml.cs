...
public partial class BettorSingleBetsCollectionViewControl : ContentView
{
    ...
    public static readonly BindableProperty CustomItemSourceProperty = BindableProperty.Create(nameof(CustomItemSource), typeof(ObservableCollection<SingleBetModel>), typeof(BettorSingleBetsCollectionViewControl), propertyChanged: (bindable, oldValue, newValue) =>
    {
    ...
    {
        get => (ObservableCollection<SingleBetModel>)GetValue(CustomItemSourceProperty);
